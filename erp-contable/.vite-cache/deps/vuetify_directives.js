...
// node_modules/.pnpm/vuetify@3.13.5_vite-plugin-vuetify@2.1.3_vue@3.5.43/node_modules/vuetify/lib/directives/scroll/index.js
...
// node_modules/.pnpm/vuetify@3.13.5_vite-plugin-vuetify@2.1.3_vue@3.5.43/node_modules/vuetify/lib/composables/directiveComponent.js
...
function mountComponent(component, props) {
  return function(el, binding, vnode) {
    ...
    const text = isObject(binding.value) ? binding.value.text : typeof binding.value === "string" ? binding.value : _props == null ? void 0 : _props.text;
...
// node_modules/.pnpm/vuetify@3.13.5_vite-plugin-vuetify@2.1.3_vue@3.5.43/node_modules/vuetify/lib/directives/tooltip/index.js
var Tooltip = useDirectiveComponent(VTooltip, (binding) => {
  var _a;
  const disabled = isObject(binding.value) ? !binding.value.text : ["", false, null, void 0].includes(binding.value);
  return {
